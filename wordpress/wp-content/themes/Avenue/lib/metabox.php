...
$meta_box = array(
	...
	'fields' => array(
			...
			'desc' => 'Ingresa el número de ID de la propiedad, si es que existe',
			'id' => $prefix . 'pid',
			'type' => 'text',
			'std' => ''
		),
		...
		array(
			'name' => 'Baños',
			'desc' => 'Número de Baños disponibles',
			'id' => $prefix . 'bath',
			'type' => 'text',
			'std' => ''
		),		
		...
		array(
			'name' => 'Cochera',
			'desc' => 'Disponibilidad y detalles de la cochera',
			'id' => $prefix . 'garage',
			'type' => 'text',
			'std' => '0'
		),		
